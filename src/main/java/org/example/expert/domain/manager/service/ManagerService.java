...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        ...
        try {
            ...
            // 성공 로그 저장 (REQUIRES_NEW로 독립적인 트랜잭션)
            logService.saveSuccessLog(todoId, user.getId(), managerUserId);
            ...
            // 실패 로그 저장 (REQUIRES_NEW로 독립적인 트랜잭션)
            // 매니저 등록이 실패해도 로그는 반드시 저장됨
            logService.saveFailureLog(todoId, user.getId(), managerUserId, e.getMessage());
